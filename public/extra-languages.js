(() => {
  const common = {
    es: {
      "Dota 2 Fantasy Optimizer":"Optimizador Fantasy de Dota 2","Build all three banners, compare roster combinations and understand exactly where every projected point comes from.":"Configura los tres estandartes, compara combinaciones y descubre de dónde sale cada punto proyectado.",
      "Banner builder":"Constructor de estandartes","Title":"Título","Best roster":"Mejor alineación","Teams":"Equipos","Teams represented by players in the current Reddit dataset.":"Equipos representados por jugadores del conjunto de datos actual.","Traits":"Propiedades","Reroll guide":"Guía de rerolls","Rules":"Reglas","Methodology":"Metodología",
      ...
      "Reddit dataset · 13 Tier 1 tournaments":"Datos históricos de partidas profesionales","Coach title support is next. Current calculations include emblem tiers and traits only.":"Los títulos de entrenador están disponibles en la sección de títulos.",
    ...
    zh: {
      "Dota 2 Fantasy Optimizer":"Dota 2 Fantasy 阵容优化器","Build all three banners, compare roster combinations and understand exactly where every projected point comes from.":"配置三面旗帜，对比阵容组合，并查看每一项预测积分的来源。",
      "Banner builder":"旗帜配置","Title":"称号","Best roster":"最佳阵容","Teams":"战队","Teams represented by players in the current Reddit dataset.":"当前数据集中包含选手的参赛战队。","Traits":"属性","Reroll guide":"重掷指南","Rules":"规则","Methodology":"计算方法",
      ...
      "Reddit dataset · 13 Tier 1 tournaments":"职业比赛历史数据","Coach title support is next. Current calculations include emblem tiers and traits only.":"教练称号已可在称号板块中使用。",
