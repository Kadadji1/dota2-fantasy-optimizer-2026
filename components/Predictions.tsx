...
type TeamOdds = { team: string; odds: Record<Category, number>; playoffs: number };
...
const teams: TeamOdds[] = [
  ...
  { team: "Team Spirit", odds: { "4-0": 8, "4-1": 15, advancing: 46, eliminated: 25, "1-4": 5.4, "0-4": 1.5 }, playoffs: 69 },
  { team: "Aurora Gaming", odds: { "4-0": 6.5, "4-1": 15, advancing: 43, eliminated: 29, "1-4": 5.3, "0-4": 1.5 }, playoffs: 65 },
  { team: "Team Liquid", odds: { "4-0": 5.3, "4-1": 12, advancing: 45, eliminated: 29, "1-4": 6.4, "0-4": 2 }, playoffs: 62 },
  ...
  { team: "OG", odds: { "4-0": 0.5, "4-1": 2, advancing: 13, eliminated: 45, "1-4": 26, "0-4": 14 }, playoffs: 15.5 },
...
function TeamLogo({ team }: { team: string }) {
  return <span className="team-logo team-logo-lg prediction-team-logo" title={team} role="img" aria-label={team} />;
}
    ...
    <main className="site-shell predictions-page">
      <header className="topbar predictions-topbar">
        ...
        <nav className="page-tabs primary-page-tabs" aria-label="Primary navigation">
          <Link href="/">Fantasy Calculator</Link><Link href="/predictions" className="active">Predictions</Link><Link href="/guide">Guide</Link>
        </nav>
      </header>

      <section className="predictions-hero compact-predictions-hero">
        <div><span className="eyebrow">THE INTERNATIONAL 2026</span><h1>Group Stage Predictions</h1><p>Swap any team and the bracket stays complete automatically.</p></div>
      </section>
      ...
      <section className="section" id="team-odds">
        <div className="section-title"><div><span className="eyebrow">PROBABILITY OF EVERY SLOT</span><h2>Team odds</h2></div></div>
