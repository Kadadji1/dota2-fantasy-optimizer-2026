...
const navigation: Record<SiteLanguage, { fantasy: string; predictions: string; guide: string }> = {
  en: { fantasy: "Fantasy Calculator", predictions: "Predictions", guide: "Guide" },
  ru: { fantasy: "Фэнтези-калькулятор", predictions: "Прогнозы", guide: "Гайд" },
  es: { fantasy: "Calculadora Fantasy", predictions: "Predicciones", guide: "Guía" },
  zh: { fantasy: "梦幻计算器", predictions: "预测", guide: "指南" }
};
