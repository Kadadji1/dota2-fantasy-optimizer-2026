...
function InteractivePredictionBoard({ language }: { language: Lang }) {
  ...
  const mobileStages: Array<{ stage: MobileStage; label: string }> = [
    { stage: "upper1", label: language === "ru" ? "Верхняя · 1" : "Upper · R1" }, { stage: "upper2", label: language === "ru" ? "Верхняя · 2" : "Upper · R2" },
    { stage: "upper3", label: language === "ru" ? "Финал верхней" : "Upper Final" }, { stage: "lower1", label: language === "ru" ? "Нижняя · 1" : "Lower · R1" },
    { stage: "lower2", label: language === "ru" ? "Нижняя · 2" : "Lower · R2" }, { stage: "lower3", label: language === "ru" ? "Финалы нижней" : "Lower Finals" },
    { stage: "final", label: language === "ru" ? "Гранд-финал" : "Grand Final" }
  ];
